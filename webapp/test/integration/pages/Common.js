sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("c2g/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("c2g.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["c2g/localService/mockserver"], function (mockserver) {
